...
CREATE TABLE `lexemes_cz` (
  ...
  `cz_text` text NOT NULL,
  `cz_wordType` enum('UNKNOWN','NOUN','VERB','ADJECTIVE','ADVERB','PREPOSITION','GERUND','CONJUNCTION','PRONOUN') NOT NULL DEFAULT 'UNKNOWN',
  `cz_phraseType` enum('UNKNOWN','PROVERB','PHRASALVERB','MODALVERB','IDIOM','COLLOQUIALISM','OTHER') NOT NULL DEFAULT 'UNKNOWN',
  `cz_type` enum('UNKNOWN','WORD','PHRASE') NOT NULL DEFAULT 'UNKNOWN',
  `cz_notes` text,
  `cz_gender` enum('UNKNOWN','MASCULINE','MASCULINEANIMATUM','FEMININE','NEUTER') NOT NULL DEFAULT 'UNKNOWN',
  `cz_verbAspect` enum('UNKNOWN','PERFECTIVE','IMPERFECTIVE') NOT NULL DEFAULT 'UNKNOWN',
...
CREATE TABLE `lexemes_en` (
  ...
  `en_type` enum('UNKNOWN','WORD','PHRASE') NOT NULL DEFAULT 'UNKNOWN',
  `en_wordType` enum('UNKNOWN','NOUN','VERB','ADJECTIVE','ADVERB','PREPOSITION','GERUND','CONJUNCTION','PRONOUN') NOT NULL DEFAULT 'UNKNOWN',
  `en_phraseType` enum('UNKNOWN','PROVERB','PHRASALVERB','MODALVERB','IDIOM','COLLOQUIALISM','OTHER') NOT NULL DEFAULT 'UNKNOWN',
  `en_notes` text,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `updateLexemePairFamiliarity` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
-- Dump completed on 2019-08-10 13:15:51
