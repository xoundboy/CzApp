...
const Cz: IDictionary = class {
	...
	public static MENULABEL_RECENT = 'Nedávno';
	...
	public static SUMMARY_LABEL_EN_TEXT = 'Anglický text';
	public static SUMMARY_LABEL_EN_NOTES = 'poznámky k anglickému textu';
	public static SUMMARY_LABEL_CZ_TEXT = 'Český text';
	public static SUMMARY_LABEL_CZ_NOTES = 'poznámky k českému textu';
	public static TAB_ENGLISH = 'Anglicky';
	public static TAB_CZECH = 'Cesky';
