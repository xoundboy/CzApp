...
CREATE DEFINER=`czapp`@`localhost` PROCEDURE `insertCzLexeme`(
  ...
  IN phraseType ENUM('NONE', 'PROVERB', 'IDIOM', 'COLLOQUIALISM', 'OTHER'),
  IN type ENUM('WORD','PHRASE'),
  IN gender ENUM('MASCULINE', 'MASCULINE_ANIMATUM', 'FEMININE', 'NEUTER'),
...
-- Dump completed on 2018-03-17 15:07:45
